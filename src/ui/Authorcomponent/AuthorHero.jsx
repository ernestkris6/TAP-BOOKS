      ...
      <section className="relative flex items-center justify-center px-6 py-20 bg-gradient-to-br from-[#f7f1e8] via-[#fdfbf7] to-[#efe3d3]">
        ...
        <div className="mx-auto text-center relative z-10">
          ...
          <motion.div
            ...
            className="mt-10"
          >
            <a href='#team' className="group bg-stone-900 text-white px-8 py-4 rounded-xs inline-flex items-center gap-3 hover:bg-stone-800 hover:px-10 transition-all duration-500 cursor-pointer">
              Explore Our Team
