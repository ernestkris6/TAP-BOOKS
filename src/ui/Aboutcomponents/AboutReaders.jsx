...
//         <div className="marquee-track flex gap-4 w-max cursor-pointer">
...
//               }}
//               whileHover={{ y: -8, scale: 1.02 }}
//               className="w-[270px] sm:w-[280px] lg:w-[320px] flex-shrink-0 bg-[#f1f1f1] border border-gray-100 rounded-2xl p-8 shadow-sm flex flex-col gap-6 transition-all duration-500"
//             >
...
//                 className="text-3xl lg:text-5xl text-stone-700"
//               >
//                 <RiDoubleQuotesL />
//               </motion.div>
...
//       {/* Slider Wrapper */}
//       <div className="relative overflow-hidden">
//         {/* flex items-stretch gap-5 w-max animate-marquee  */}
//         {/* Sliding Track & Sliding Track Hover*/}
//         <div className="marquee-track flex gap-4 w-max cursor-pointer">
...
//             <div
//               key={index}
//               className="w-[270px] sm:w-[280px] lg:w-[320px] flex-shrink-0 bg-[#f1f1f1] border border-gray-100 rounded-sm p-8 shadow-sm flex flex-col gap-6"
//             >
//               <div className="text-base sm:text-lg lg:text-5xl text-stone-700">
//                 <RiDoubleQuotesL />
//               </div>
