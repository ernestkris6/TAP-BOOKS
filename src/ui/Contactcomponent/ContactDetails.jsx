...
export default function ContactPage() {
  return (
    <section className="relative tems-center justify-center">
      {/*IMAGE*/}
      ...
      <div className="relative flex flex-col md:flex-row gap-10 mx-auto z-10 max-w-6xl bg-white/10 backdrop-blur-lg p-8 shadow-xl rounded-b-xs mt-8 mb-18 md:mb-12">
