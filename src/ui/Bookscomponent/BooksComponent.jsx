            ...
            >
              ...
              <div className="max-w-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button className="group bg-stone-900 hover:bg-black text-white px-8 py-4 rounded-full transition-all duration-500 cursor-pointer flex items-center justify-center gap-3">
                  ...
                  <Link
                    to={`/books/${book.id}`}
                    className="border border-stone-300 hover:border-stone-800 text-stone-700 hover:text-stone-900 px-8 py-4 rounded-full transition-all duration-500 flex justify-center items-center"
                  >
                    View Details
                  </Link>
